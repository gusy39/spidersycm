 ...
 */
@Component("accountantSeleniumSpider")
public class AccountantSeleniumSpider extends SeleniumSpider {
...
//        String password = "yiheng@hayao%*";
        ...
        String login_url = "https://pay.taobao.com/payments/expendDetail.htm";
