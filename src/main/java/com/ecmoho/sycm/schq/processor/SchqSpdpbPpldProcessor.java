	...
	public void process(Page page) {
		   ...
		   switch (childAccount) {
		       ...
		       case "spdpb-ppld-rxsp":
				      spiderSchqDataDao.addListData(dataList, "sycm_commodityshop_brand_hotcommodityranking");
				      break;
			   //��Ʒ���̰�_��ҵ����_������Ʒ��     
		       case "spdpb-ppld-llsp":
				      spiderSchqDataDao.addListData(dataList, "sycm_commodityshop_brand_flowcommodityranking");
			          break;
			   //��Ʒ���̰�_��ҵ����_�������̰�     
		       case "spdpb-ppld-rxdp":
				      spiderSchqDataDao.addListData(dataList, "sycm_commodityshop_brand_hotshopranking");
			          break;
			   //��Ʒ���̰�_��ҵ����_�������̰�   
		       case "spdpb-ppld-lldp":
				       spiderSchqDataDao.addListData(dataList, "sycm_commodityshop_brand_flowshopranking");
			           break;
		       default:
			           break;
	        }
